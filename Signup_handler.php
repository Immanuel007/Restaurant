...
if (isset($_POST['signup'])) {
    ...
    $sql = "SELECT * FROM `cook` WHERE firstname='$firstname' OR email='$email' LIMIT 1";
    ...
    $sql = "INSERT INTO `cook`(`id`, `firstname`, `lastname`, `email`, `password`) VALUES (null,'$firstname','$lastname','$email','$password_1')";
